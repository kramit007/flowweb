...
<head>
    ...
    ================================================== -->
    <meta charset="utf-8">
    <title>Flowweb-Login Here</title>
    ...
    <section id="hero" class="s-hero target-section">
        ...
        <div class="row s-hero__content">
            <div class="column">
                ...
                <h1 style="font-size: 80px;">SIGN<span style="color: white;">-IN</span></h1>

                <div class="s-hero__content-about">
                  <h3>Flow Web Disgning</h3>
                    <p>
                    Get your project after<br> <span style="color: #d9083c">login</span> to your account.
                    </p>
                <a class="btn btn--primary h-small-width" href="register.php" style="margin-top: -20px;">SIGN-UP</a>
                    <footer>
...
<!--registration form---->
        ...
        <div class="row">
            ...
            <div class="column large-12 tab-12">
                ...
                <h3 class="h-add-bottom">Login</h3>
...
if($row)
{
    $certipass = mysqli_fetch_assoc($query);
     ...
     $_SESSION['email'] = $certipass['email'];
